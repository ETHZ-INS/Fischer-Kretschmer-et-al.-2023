...
p1
saveRDS(p1,"../object_resources/figure_1_sup_meta/p1.rds")
```
...
head(ame1)
saveRDS(ame1,"../object_resources/figure_1_sup_meta/AME_1_5fC_no5fC_TSS.rds")
...
saveRDS(ame2,"../object_resources/figure_1_sup_meta/AME_2_total_5fC_no5fC.rds")
```
...
```{r}
saveRDS(archtype_enrich,"../object_resources/figure_1_sup_meta/archtype_enrich.list.rds")
#archtype_enrich <- readRDS("archtype_enrich.list.rds")
```
...
pp <- plot_grid(p1+theme(text = element_text(size = 9))+ggtitle("Fragment size distribution (Chr1)"),p2,p3,p4,nrow = 2,ncol = 2,labels = c("A","B","C","D"))
pp


pdf("figure_1_sup_meta.pdf", width=10, height=7.5)
pp
dev.off()
```
