...
#sc <- readRDS("../object_resources/figure_3_meta/p1.counts.rds")
...
#diffMotif <- readRDS("../object_resources/figure_3_meta/p1.rds")
...
# saveRDS(diffMotif_5fC,"../object_resources/figure_3_meta/p2.rds")
# diffMotif_5fC <- readRDS("../object_resources/figure_3_meta/p2.rds")
```
...
gg <- ggplot(mores, aes(logFC, -log10(adj.P.Val
  ...
  labs(x="activity norm. z-score logFC")+ xlim(c(-5,3.5))+
  geom_hline(yintercept=-log10(0.05), linetype="dashed")+
  geom_text(aes(2,-log10(0.05),label = "adjst.p-value = 0.05", vjust = -1.5,),size = 3.5)+
...
pdf("figure_3_meta.pdf", width=9, height=8)
pp
dev.off()
```
